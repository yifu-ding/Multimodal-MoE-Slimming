...
def install_deepseek_loader_into(model_module) -> None:
    ...
    model_module.DeepseekV2ForCausalLM.load_weights = patched
    ...
    if plan_path and strategy == "multi_kernel":
        ...
        def patched_moe_init(self, config, parallel_config, quant_config=None, prefix=""):
        ...
        model_module.DeepseekV2MoE.__init__ = patched_moe_init
    model_module._maes_mistral4_loader_installed = True
