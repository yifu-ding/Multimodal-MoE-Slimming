...
def install_into(layer_module: ModuleType) -> None:
    """Configure one imported vLLM fused-MoE module in the current worker."""
    ...
    layer_module.FusedMoE.__init__ = runtime_init
    layer_module.FusedMoE.weight_loader = runtime_weight_loader
...
def install_qwen_moe_into(model_module: ModuleType) -> None:
    ...
    class MultiKernelExperts(nn.Module):
        def __init__(self, vllm_config, prefix: str, model_layer_id: int):
            ...
            # exactly one group's own (runtime-configured, slicing-aware)
    ...
    def runtime_init(self, vllm_config, prefix: str = ""):
    ...
    model_module.Qwen3MoeSparseMoeBlock.__init__ = runtime_init
    ...
    def runtime_model_load_weights(self, weights):
    ...
    model_module.Qwen3MoeModel.load_weights = runtime_model_load_weights
...
def install_kimi_moe_into(model_module: ModuleType) -> None:
    ...
    def runtime_init(self, config, parallel_config, quant_config=None, prefix: str = ""):
    ...
    model_module.DeepseekV2MoE.__init__ = runtime_init
    ...
    model_module.DeepseekV2ForCausalLM.load_weights = runtime_model_load_weights
...
def install_qwen_vl_loader_into(model_module: ModuleType) -> None:
    ...
    def runtime_load_fused_expert_weights(
    ...
    def runtime_load_weights(self, weights):
    ...
    cls.load_fused_expert_weights = runtime_load_fused_expert_weights
    cls.load_weights = runtime_load_weights
